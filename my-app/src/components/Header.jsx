...
function Header() {
    ...
    return (
        <nav className="main-nav">
            <NavBarLinks navClassName="main-nav-logo permanent-header" navDirection="/" navImgClassName="main-nav-logo-image" navImgSrc={headerImg} navImgAlt="Argent Bank Logo" />
            ...
            <div className="user-name-div">
                ...
                <NavBarLinks navClassName="main-nav-item signOut-btn temporary-header"
